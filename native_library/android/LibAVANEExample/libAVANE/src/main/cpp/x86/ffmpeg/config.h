...
#define FFMPEG_CONFIGURATION "--target-os=linux --prefix=../../VPlayer_library/jni/ffmpeg-build/x86 --enable-cross-compile --extra-libs=-lgcc --arch=x86 --cc=/Users/User/Library/Android/sdk/ndk-bundle/toolchains/x86-4.9/prebuilt/darwin-x86_64/bin/i686-linux-android-gcc --cross-prefix=/Users/User/Library/Android/sdk/ndk-bundle/toolchains/x86-4.9/prebuilt/darwin-x86_64/bin/i686-linux-android- --nm=/Users/User/Library/Android/sdk/ndk-bundle/toolchains/x86-4.9/prebuilt/darwin-x86_64/bin/i686-linux-android-nm --sysroot=/Users/User/Library/Android/sdk/ndk-bundle/platforms/android-19/arch-x86/ --extra-cflags=' -O3 -fpic -DANDROID -DHAVE_SYS_UIO_H=1 -Dipv6mr_interface=ipv6mr_ifindex -fasm -Wno-psabi -fno-short-enums -fno-strict-aliasing -finline-limit=300 -m32 ' --disable-shared --enable-static --enable-runtime-cpudetect --extra-ldflags='-Wl,-rpath-link=/Users/User/Library/Android/sdk/ndk-bundle/platforms/android-19/arch-x86//usr/lib -L/Users/User/Library/Android/sdk/ndk-bundle/platforms/android-19/arch-x86//usr/lib -nostdlib -lc -lm -ldl -llog -L../../VPlayer_library/jni/ffmpeg-build/x86/lib' --extra-cflags=-I../../VPlayer_library/jni/ffmpeg-build/x86/include --enable-libx264 --enable-avformat --enable-avcodec --enable-avfilter --enable-avresample --disable-avdevice --enable-swresample --enable-zlib --disable-doc --disable-programs --disable-nvenc --enable-gpl --enable-version3 --enable-memalign-hack --enable-asm --disable-asm --enable-gpl --enable-libx264"
#define FFMPEG_LICENSE "GPL version 3 or later"
#define CONFIG_THIS_YEAR 2016
#define FFMPEG_DATADIR "../../VPlayer_library/jni/ffmpeg-build/x86/share/ffmpeg"
#define AVCONV_DATADIR "../../VPlayer_library/jni/ffmpeg-build/x86/share/ffmpeg"
